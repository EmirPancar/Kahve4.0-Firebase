...
<!-----------------------------------------------Kahve Yazısı Bitiş------------------------------------------------------------->
    ...
    <div class="Baslik">KLASİK ÇAY ÇEŞİTLERİ</div>
        ...
        <?php
            $espressoCards = array_filter($cards, function ($card) {
                return $card['category'] === 'Klasik' && $card['page'] === 'Sıcak Çay';
            });
    ...
    <div class="Baslik">BİTKİ ÇAYI ÇEŞİTLERİ</div>

        <?php
            $filterCards = array_filter($cards, function ($card) {
                return $card['category'] === 'Bitki' && $card['page'] === 'Sıcak Çay';
            });
...
<div class="Baslik">AROMALI ÇAY ÇEŞİTLERİ</div>

<?php
$flavoredCards = array_filter($cards, function ($card) {
    return $card['category'] === 'Aromalı' && $card['page'] === 'Sıcak Çay';
});
