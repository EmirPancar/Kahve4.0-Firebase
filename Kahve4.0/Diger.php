...
<video id="background-video" muted>
    <source src="Gorsel/Bubble1.mp4" type="video/mp4">
  </video>
...
<!-----------------------------------------------Kahve Yazısı Bitiş------------------------------------------------------------->
    ...
    <div class="Baslik">SOĞUK İÇECEK ÇEŞİTLERİ</div>

        <?php
            $espressoCards = array_filter($cards, function ($card) {
                return $card['category'] === 'Soğuk' && $card['page'] === 'Diğer';
            });
    ...
    <div class="Baslik">SICAK İÇECEK ÇEŞİTLERİ</div>

        <?php
            $filterCards = array_filter($cards, function ($card) {
                return $card['category'] === 'Sıcak' && $card['page'] === 'Diğer';
            });
