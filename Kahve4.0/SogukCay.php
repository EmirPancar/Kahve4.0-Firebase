...
<video id="background-video" muted>
    <source src="Gorsel/Green Leaves Falling Black Screen video loops (online-video-cutter.com).mp4" type="video/mp4">
  </video>
...
<!-----------------------------------------------Kahve Yazısı Bitiş------------------------------------------------------------->
    ...
    <div class="Baslik">KLASİK ÇAY ÇEŞİTLERİ</div>

        <?php
            $espressoCards = array_filter($cards, function ($card) {
                return $card['category'] === 'Soğuk Klasik' && $card['page'] === 'Soğuk Çay';
            });
    ...
    <div class="Baslik">MEYVELİ ÇAY ÇEŞİTLERİ</div>

        <?php
            $filterCards = array_filter($cards, function ($card) {
                return $card['category'] === 'Soğuk Meyveli' && $card['page'] === 'Soğuk Çay';
            });
...
<div class="Baslik">BİTKİSEL ÇAY ÇEŞİTLERİ</div>

<?php
$flavoredCards = array_filter($cards, function ($card) {
    return $card['category'] === 'Soğuk Bitkisel' && $card['page'] === 'Soğuk Çay';
});
...
<div class="SatirSonu">
    <div class="container-eg-btn-2">
      ...
      <a class="button button-6" href="SogukKahve.php">Soğuk Kahve</a>     
