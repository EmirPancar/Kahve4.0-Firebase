...
<!-----------------------------------------------Kahve Yazısı Bitiş------------------------------------------------------------->
    ...
    <div class="Baslik">ESPRESSO ÇEŞİTLERİ</div>

        <?php
            $espressoCards = array_filter($cards, function ($card) {
                return $card['category'] === 'Espresso' && $card['page'] === 'Sıcak Kahve';
            });
    ...
    <div class="Baslik">FİLTRE KAHVE ÇEŞİTLERİ</div>

        <?php
            $filterCards = array_filter($cards, function ($card) {
                return $card['category'] === 'Filtre' && $card['page'] === 'Sıcak Kahve';
            });
...
<!-- Sütlü ve Aromalı Kahve Çeşitleri -->
<div class="Baslik">SÜTLÜ VE AROMALI KAHVE ÇEŞİTLERİ</div>

<?php
$flavoredCards = array_filter($cards, function ($card) {
    return $card['category'] === 'Sütlü' && $card['page'] === 'Sıcak Kahve';
});
